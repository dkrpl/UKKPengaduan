                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row['telp']; ?></td>
                                    <td>
                                        <a href="<?php echo site_url('pengguna/edit_masyarakat/' . $row['nik']); ?>" class="btn btn-primary">Edit</a>
                                        <a href="<?= base_url('pengguna/hapus_masyarakat/') ?><?= $row['nik'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Mau Hapus?')"> Hapus </a>
                                    </td>
